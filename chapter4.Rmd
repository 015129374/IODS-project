...
```{r, echo=FALSE}
km <- kmeans(boston_bonus, centers = 2)
pairs(boston_bonus, col = km$cluster)
```

And here the LDA model:
...
```{r, echo=FALSE, include=FALSE}
classes <- as.numeric(boston_bonus$crim)
```
...
The most influential variable as cluster linear separator is.
